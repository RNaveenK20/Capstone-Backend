...
namespace server.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public LoginController(RecipeManagementDbContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<IActionResult> Post([FromBody] UserLogin userLogin)
        {
            ...
            var user = _context.Users.SingleOrDefault(u => u.Email == userLogin.registeredEmailAddr);
            if (user == null)
            {
